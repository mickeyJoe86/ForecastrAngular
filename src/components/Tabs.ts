const Tabs = {
        ...
        <div ng-cloak>
            <md-content>
                <md-tabs md-dynamic-height md-border-bottom>
                    <md-tab label="currently">
                        <md-content class="md-padding">
                            <h1 class="md-display-2">Currently</h1>  
                            <p>Temperature: {{ $tabsCtrl.forecastdata.currently.apparentTemperature }}&deg</p>
                            <p>Precip: {{ $tabsCtrl.forecastdata.currently.precipProbability }}&#37</p>
                            <p>Description: {{ $tabsCtrl.forecastdata.currently.summary }}</p>
                        </md-content>
                    </md-tab> 
                    <md-tab label="hourly">
                        <md-content class="md-padding">
    ...
    controller: class TabsController {
        constructor() {};
        $onInit() {}
    },   
